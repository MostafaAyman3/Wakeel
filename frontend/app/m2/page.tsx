...
export default function M2Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-8 px-4 sm:px-6 lg:px-8" dir="rtl">
      <div className="max-w-7xl mx-auto space-y-8">
        
        {/* Header */}
        <div className="md:flex md:items-center md:justify-between bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        ...
        {loadingInventory && !inventoryData ? (
          <div className="text-center py-12">
            <p className="text-gray-500">جاري تحميل بيانات المخزون...</p>
          </div>
        ) : (
          <>
            {/* Inventory Table */}
